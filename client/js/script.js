...
const init = async function () {
  try {
    ...
    const resume = await axios.post(`https://lionfish-app-g5i4e.ondigitalocean.app/resume/:${id}`);

    const templatesRes = await axios.post(
      `https://lionfish-app-g5i4e.ondigitalocean.app/resume/gettemplate/:${id}`
    );
...
try {
  ...
  const res = await axios.post("https://lionfish-app-g5i4e.ondigitalocean.app/resume/create",{
    ...data,
  });
...
templates.addEventListener("click", async (e) => {
  ...
  // templates.classList.add("hiddenClass");
  const res = await axios.post("https://lionfish-app-g5i4e.ondigitalocean.app/resume/savetemplate/", {
    templateData,
  });
